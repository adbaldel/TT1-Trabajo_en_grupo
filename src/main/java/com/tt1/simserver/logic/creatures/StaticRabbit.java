...
public class StaticRabbit extends LogicCreature {
    ...
    /**
     * Construye un conejo estático vivo con la criatura base, aguante sin comida, probabilidad de reproducción,
     * posición y generador de números pseudo-aleatorios pasados como parámetros; y asociado al tablero
     * {@code simulationGrid}. Asume que la criatura base es no nula; que el número de ticks que aguanta sin comer antes
     * de morirse de hambre {@code starvationThreshold} es mayor o igual a cero; que la probabilidad de multiplicarse
     * está entre 0.0 y 1.0 (1.0 incluido); que la posición es no nula; que el tablero es no nulo y contiene a la
     * criatura en la posición de la criatura; y que el generador de números pseudo-aleatorios es no nulo.
     *
     ...
     */
    public StaticRabbit(Creature creature, int starvationThreshold, double multiplyProbability,
                        Position position,
     ...
     * la criatura base es no nula; que el número de ticks que aguanta sin comer antes de morirse de hambre
     * {@code starvationThreshold} es mayor o igual a cero; que la probabilidad de multiplicarse está entre 0.0 y 1.0
     * (1.0 incluido); que la posición es no nula; y que el generador de números pseudo-aleatorios es no nulo.
     *
     * @param creature            la criatura base.
     * @param starvationThreshold el número de ticks que la criatura aguanta sin comer antes de morirse.
     * @param multiplyProbability la probabilidad de reproducirse de la criatura.
